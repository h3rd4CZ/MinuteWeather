namespace MauiNotifications.Model.WeatherCurrent;


public class WeatherCurrentResult
{
    public CurrentResult[] results { get; set; }
}

public class CurrentResult
{
    public bool Loaded { get; set; }
    public double Test { get; set; } = 210;
    public DateTime dateTime { get; set; }
    public string phrase { get; set; }
    public int iconCode { get; set; }
    public string IconCodeName => $"w{iconCode}";
    ...
    public string relativeHumidityString => $"{Utils.IconFont.Water} {relativeHumidity} %";
    ...
    public string cloudCoverValue => $"{Utils.IconFont.Cloud} {cloudCover} %";
...
public class Temperature
{
    ...
    public override string ToString() => $"{Math.Round(value)}°";
}
...
public class Wind
{
    ...
    public override string ToString() => $"{Math.Round(speed.value / 3.6, 1)} m/s";
}
...
public class Visibility
{
    ...
    public override string ToString() => $"{Utils.IconFont.Eye} {value} {unit}";
}
...
public class Pressure
{
    ...
    public override string ToString() => $"{Utils.IconFont.Gauge} {Math.Round(value)} {unit}";
}
...
public class Past24hours
{
    ...
    public override string ToString() => $"{Utils.IconFont.WeatherRainy} {value} {unit} / 24";
}
